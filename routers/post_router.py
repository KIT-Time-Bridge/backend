...
def all_missing_search_in_missing(pageNum:int, request:Request, missing_name: Optional[str] = None, missing_situation: Optional[str] = None, missing_extra_evidence: Optional[str] = None, gender_id: Optional[int] = None, missing_birth: Optional[str] = None, missing_date: Optional[str] = None, missing_place: Optional[str] = None, db: Session = Depends(get_db)):
    post_controller=PostController()
    return post_controller.all_missing_search_by_missing(pageNum, db, missing_name, missing_situation, missing_extra_evidence, gender_id, missing_birth, missing_date, missing_place)

@router.post("/all_missing_search_family")
def all_missing_search_in_family(pageNum:int, request:Request, missing_name: Optional[str] = None, missing_situation: Optional[str] = None, missing_extra_evidence: Optional[str] = None, gender_id: Optional[int] = None, missing_birth: Optional[str] = None, missing_date: Optional[str] = None, missing_place: Optional[str] = None, db: Session = Depends(get_db)):
    post_controller=PostController()
    return post_controller.all_missing_search_by_family(pageNum, db, missing_name, missing_situation, missing_extra_evidence, gender_id, missing_birth, missing_date, missing_place)
